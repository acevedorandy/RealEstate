...
{
    public class UpdateMejorasCommand : IRequest<int>
    {
    ...
    public class UpdateMejorasCommandHandler : IRequestHandler<UpdateMejorasCommand, int>
    {
        ...
        public async Task<int> Handle(UpdateMejorasCommand request, CancellationToken cancellationToken)
        {
            ...
            var mejora = (Mejoras)mejoraGet.Data;
